...
function sendEmail(e) {
   ...
   emailjs.sendForm('gmail', 'template_32690m2', e.target, 'user_6MfeK5RxUPXBPqV9Mvq2V')
     .then((result) => {
        ...
        return (
            <div className="couple-wrapper">
                ...
                <div className="bottom-couple">
                    ...
                    <div className="input-boxes" onSubmit={sendEmail} >

                        <div className="name">

                            <div className="input-text-couple">
                                <div className="text">
                                    *First Name
                                </div>
                        ...
                        <div className="button">
                            <button className="btn" type="submit" value="Send" onClick={sendEmail}>
                                Send
                            </button>
                        </div>
